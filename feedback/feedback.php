    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
           <a class="nav-link" href="/php-crash-course-2020-master/feedback/index.php">Home</a>
         </li>
         <li class="nav-item">
           <a class="nav-link" href="/php-crash-course-2020-master/feedback/feedback.php">Feedback</a>
         </li>
         <li class="nav-item">
           <a class="nav-link" href="/php-crash-course-2020-master/feedback/about.php">About</a>
         </li>
        </ul>
      </div>
  </div>
